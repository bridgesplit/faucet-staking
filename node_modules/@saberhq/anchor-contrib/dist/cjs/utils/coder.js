...
const generateAccountParsers_1 = require("../generateAccountParsers");
...
class SuperCoder {
    ...
    idl) {
        ...
        this.accounts = (0, accounts_1.generateAnchorAccounts)(address, (_a = idl.accounts) !== null && _a !== void 0 ? _a : [], this.coder.accounts);
        this.errorMap = (0, errors_1.generateErrorMap)(idl);
        const accountsList = Object.values(this.accounts);
        const accountTypeDefs = {};
        accountsList.forEach((account) => {
            accountTypeDefs[account.name] = account.idl;
        });
        this.accountParsers = (0, generateAccountParsers_1.generateAccountParsersFromCoder)((_b = idl.accounts) === null || _b === void 0 ? void 0 : _b.map((acc) => acc.name), this.coder.accounts);
        this.accountTypeDefs = accountTypeDefs;
        this.discriminators = accountsList.reduce((acc, el) => (Object.assign(Object.assign({}, acc), { [el.discriminator.toString("hex")]: el.name })), {});
        this.discriminatorsByAccount = accountsList.reduce((acc, el) => (Object.assign(Object.assign({}, acc), { [el.name]: el.discriminator })), {});
    }
    /**
    ...
    encodeIX(name, args, accounts) {
        ...
        const keys = instruction_1.default.accountsArray(accounts, idlIx.accounts, name);
    ...
    parseInstruction(txInstruction) {
        ...
        return Object.assign(Object.assign({}, fmt), { name: decoded.name });
    }
    /**
     ...
     */
    getProgram(provider) {
        return (0, programs_1.newProgram)(this.idl, this.address, provider);
    }
}
